...
关联文档：[[SPEC_RAG_TOOL_OPTIMIZATION.md]] [[SPEC_REMOVE_QUERY_PREPROCESSING.md]] [[PROJECT_ANALYSIS.md §4.9]] [[SPEC_PRONOUN_RESOLUTION_OPTIMIZATION.md]]（入口消解层 1 历史门控，关联工作项）
